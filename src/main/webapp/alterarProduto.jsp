        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 text-center my-2">
                    ...
                    <h1 class="display-4">Alteração de produto</h1>
            ...
            <div class="row justify-content-center mb-5">
                ...
                <div class="col-sm-12 col-md-10 col-lg-8">
                    ...
                    <form method="post" action="alterarProduto">
						...
						<c:set var="produtoBusca" value="${produtoBusca}" ></c:set> 
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-8">
                                ...
                                <input type="text" class="form-control" name="inputNome" placeholder="Nome" value="${produtoBusca.nome}"/>
                            ...
                            <div class="form-group col-4">
                                ...
                                <select class="form-control" name="inputUnVenda" >
                                    <option selected value="${produtoBusca.undVenda}"></option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="numeric" class="form-control" name="inputPrecoCompra" placeholder="R$" value="${produtoBusca.precoCusto}">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="number" class="form-control" name="inputPrecoVenda" placeholder="R$" value="${produtoBusca.precoVenda}">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control" name="inputMargemLucro" placeholder="lucro (%)" value="${produtoBusca.margemLucro}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="number" class="form-control" name="inputQuantidade" placeholder="Quantidade" value="${produtoBusca.quantidade}">
