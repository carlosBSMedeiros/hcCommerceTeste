        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-5">
                ...
                <div class="col-sm-12 col-md-10 col-lg-8">
                    ...
                    <form method="post" action="alterarPessoa">
					
					<c:set var="pessoaBusca" value="${pessoaBusca}"></c:set> 
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-8">
                                ...
                                <input type="text" class="form-control" name="inputNome" placeholder="Nome" value="${pessoaBusca.nome}"/></input>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control" name="inputCidade" placeholder="Cidade" value="${pessoaBusca.cidade}">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control" name="inputBairro" placeholder="Bairro" value="${pessoaBusca.bairro}">

                            </div>

                            <div class="form-group col-4">

                                <label for="inputCPFCNPJ">CPF ou CNPJ<span class="alerta-erro">*</span></label>
                                <input type="text" class="form-control" name="inputCPFCNPJ" placeholder="CPF ou CNPJ" value="${pessoaBusca.cpfCNPJ}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-5">
                                ...
                                <input type="text" class="form-control" name="inputTelefone" placeholder="(xx)xxxxx-xxxx" value="${pessoaBusca.telefone}">
                            ...
                            <div class="form-group col-7">
                                ...
                                <input type="text" class="form-control" name="inputEmail" placeholder="E-mail" value="${pessoaBusca.email}">
                        ...
                        <div class="form-row">  
                            ...
                            <div class="form-group col-sm-12 ml-auto">
                                ...
                                <button type="submit" class="btn btn-primary my-1" >Alterar</button>
                                
                                <a class="btn btn-primary btn" href="pessoasCadastradas"  role="button">Voltar a lista</a>
